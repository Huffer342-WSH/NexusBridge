...
func (s *Server) Handler() http.Handler {
	...
	r.Get("/api/settings/media-libraries", s.handleGetSubtitleScanSettings)
	r.Put("/api/settings/media-libraries", s.handleSaveSubtitleScanSettings)
	...
	r.Put("/api/playback/external-subtitle", s.handleSavePlaybackExternalSubtitle)
	r.Delete("/api/playback/external-subtitle", s.handleDeletePlaybackExternalSubtitle)
	r.Get("/api/playback/external-subtitle", s.handlePlaybackExternalSubtitle)
	...
	r.Get("/api/torrents/{site_id}/{torrent_id}/media/{file_index}/thumbnail", s.handleTorrentVideoThumbnail)
	...
	r.Get("/api/playback/qb/{hash}/media/{file_index}/thumbnail", s.handleQBVideoThumbnail)
	...
	r.Get("/api/playback/file/thumbnail", s.handleFileVideoThumbnail)
